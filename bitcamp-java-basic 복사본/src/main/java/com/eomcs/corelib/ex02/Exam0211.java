...
//    // String 리터럴의 경우처럼 상수풀에 인티저 객체를 생성한다.
//    // 같은 값의 인티저 객체가 여러 개 생성되지 않도록 한다.
//    Integer i3 = Integer.valueOf(127); // 인티저 상수풀에 새로 만든다.
//    Integer i4 = Integer.valueOf(127); // 인티저 상수풀에서 이미 존재하는 주소를 가져온다.
//    System.out.println(i3 == i4); // true
//    System.out.println(i1 == i4); // false
//    // 이유?
//    System.out.println("-----");
//
//    Integer x = Integer.valueOf(-128); // 인티저 상수풀에 새로 만든다.
//    Integer y = Integer.valueOf(-128); // 인티저 상수풀에서 이미 존재하는 주소를 가져온다.
...
//    // => 상수풀에 생성된 객체는 자바 버추얼 머신이 종료되기 전까지 유지된다.
//    // => 가비지가 되지 않는다.
//    // => 그러나 힙에 생성된 객체는 주소를 잃어버리면 가비지가 되기 때문에
