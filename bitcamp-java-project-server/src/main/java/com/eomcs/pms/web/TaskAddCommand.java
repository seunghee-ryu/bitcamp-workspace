...
public class TaskAddCommand implements Command {
  ...
  public TaskAddCommand(TaskService taskService, MemberService memberService, ProjectService projectService) {
    ...
    try {
      ...
      try {
        ...
        while (true) {
          ...
          out.printf("멤버 번호가 맞지 않습니다.\n");
        }

        // 작업 정보를 입력한다.
        taskService.add(task);

        out.printf("작업을 등록했습니다.");
