...
public class Exam0110 {
  public static void main(String[] args) {
    class A {
      ...
      boolean v2; // true/false 논리값을 저장할 메모리를 만드라는 명령
  ...
  // 이 인스턴스의 주소를 저장하는 obj1, obj2, obj3를 "레퍼런스"라고 부른다.
  // 인스턴스가 생성될 때 만들어지는 v1, v2 변수를 "인스턴스 변수" 라고 부른다.
...
//    // 인스턴스 변수
//    class A { // 설계도
//      int v1; // non-static variable = instance field
//      boolean v2;
//    }
//
//    A obj1 = new A(); // ();는 생성자 호출
//    A obj2 = new A();
//    A obj3 = new A();
//
//    obj1.v1 = 100;
