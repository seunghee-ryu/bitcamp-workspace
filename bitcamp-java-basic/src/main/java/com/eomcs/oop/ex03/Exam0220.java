...
public class Exam0220 {
  static class A{
    ...
    void m3() {
      ...
      //인스턴스 변수를 사용할 때 this 를 생략할 수 있다.
    ...
    void m4(int value) {
      ...
      // 따라서 로컬 변수가 아닌 인스턴스 변수를 가리키고 싶으면
      // this를 붙인다.
    ...
    public static void main(String[] args) {
      ...
      //그래서 클래스 메서드는 this 라는 내장 변수가 없는 것이다.
      A.m1();

      A obj1 = new A();

      obj1.m2();
      //인스턴스 메서드는 인스턴스 주소가 있어야 호출할 수 있기 때문에
      ...
      //그래서 메서드가 호출될 때마다 this 변수 값이 바뀐다.
