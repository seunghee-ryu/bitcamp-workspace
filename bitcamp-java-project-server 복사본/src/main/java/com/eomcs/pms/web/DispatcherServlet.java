...
public class DispatcherServlet extends HttpServlet {
  ...
  Map<String,Controller> beanContainer;

  @SuppressWarnings("unchecked")
  @Override
  public void init() throws ServletException {
    beanContainer = (Map<String, Controller>) this.getServletContext().getAttribute("beanContainer");
    ...
    try {
      ...
      System.out.println("DispatcherServlet에서 페이지 컨트롤러를 준비하는 중 오류 발생");
    }
  }
